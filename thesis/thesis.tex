...
% Dolgozat metaadatai
% Document's metadata
\title{Application for Precision Livestock Farming of Free-Range Pigs} % cím / title
...
\supervisor{Dr. Tomas Horvath} % belső témavezető neve / internal supervisor's name
\affiliation{Head Of Department} % belső témavezető beosztása / internal supervisor's affiliation
...
\department{Department of Data Science} % tanszék neve / department's name
...
% List of to-dos (not in the final document)
...
\maketitle
\includepdf[pages=-]{topicdeclaration.pdf}
% \topicdeclaration
